...
THREE.TrackballControls = function ( object, domElement ) {
	...
	function mousedown( event, args ) {

		var projector = new THREE.Projector();
		var mouseVector = new THREE.Vector3();

		mouseVector.x = 2 * (event.clientX / _this.screen.width) - 1;
		mouseVector.y = 1 - 2 * ( event.clientY / _this.screen.height );

		_this.raycaster = projector.pickingRay( mouseVector.clone(), _this.object );
