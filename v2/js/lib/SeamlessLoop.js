...
SeamlessLoop.prototype.volume = function(vol) {
	if(typeof vol != "undefined" ) {
		if (typeof this.actual._1 != "undefined" )
			this.actual._1.volume = vol;
		if (typeof this.actual._2 != "undefined" )
...
SeamlessLoop.prototype.callback = function(cb_loaded, args) {
	this.cb_loaded = cb_loaded;
	this.cb_loaded_args = args;
	if(this.isLoaded() == true) cb_loaded(args);
